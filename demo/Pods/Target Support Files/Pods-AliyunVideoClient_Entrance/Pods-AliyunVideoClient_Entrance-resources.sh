...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/FURenderKit/Resources/model/ai_hairseg.bundle"
  ...
  install_resource "${PODS_ROOT}/FURenderKit/Resources/model/ai_human_processor_mb_fast.bundle"
