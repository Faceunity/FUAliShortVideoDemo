...
- (void)setupSubviews {
    ...
    self.playScrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, StatusBarHeight+44, ScreenWidth, ScreenHeight-StatusBarHeight-44)];
    self.playScrollView.contentSize =CGSizeMake(ScreenWidth, ScreenWidth * _videoSize.height/_videoSize.width);
    self.playScrollView.showsHorizontalScrollIndicator = NO;
    [self.view addSubview:self.playScrollView];
    
    self.playView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth, ScreenWidth * _videoSize.height/_videoSize.width)];
