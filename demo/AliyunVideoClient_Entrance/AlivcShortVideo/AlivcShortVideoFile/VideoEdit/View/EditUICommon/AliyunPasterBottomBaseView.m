...
-(UIView *)bottomBar{
    if (!_bottomBar) {
        _bottomBar = [[UIView alloc] initWithFrame:CGRectMake(0, CGRectGetHeight(self.frame) - self.bottomBarHeight, CGRectGetWidth(self.bounds), self.bottomBarHeight)];
...
- (UICollectionView *)pasterCollectionView{
    if (!_pasterCollectionView) {
        ...
        _pasterCollectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(self.timeLinePalletView.frame), CGRectGetWidth(self.frame), CGRectGetHeight(self.frame) - self.bottomBarHeight-CGRectGetMaxY(self.timeLinePalletView.frame)) collectionViewLayout:layout];
