...
-(void)setSubviews{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        [self->_tabbar selectItemAtIndexPath:[NSIndexPath indexPathForRow:0 inSection:0] animated:YES scrollPosition:UICollectionViewScrollPositionNone];
    }); 
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    TabBarItemType type = (TabBarItemType)[_tabItems[indexPath.row] integerValue];
    AliyunTabBarCell *cell = (AliyunTabBarCell *)[collectionView cellForItemAtIndexPath:indexPath];
    if (cell == _lastAliyunTabBarCell && cell != nil) {
        return;
    }
...
-(void)setTabItems:(NSArray *)tabItems{
    ...
    [self.tabbar selectItemAtIndexPath:[NSIndexPath indexPathForRow:0 inSection:0] animated:NO scrollPosition:UICollectionViewScrollPositionNone];
    [self collectionView:self.tabbar didSelectItemAtIndexPath:[NSIndexPath indexPathForRow:0 inSection:0]];
}
