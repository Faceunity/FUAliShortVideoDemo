...
@interface AlivcRaceLiveBeautifySlider : UISlider

@property (nonatomic, copy) void(^ aliViewDidLayout)(AlivcRaceLiveBeautifySlider *slider);
...
@implementation AlivcRaceLiveBeautifySlider
...
- (void)layoutSubviews {
    ...
    if (self.subviews.count > 2) {
        ...
        point.x = leftInset + ((width - leftInset * 2) * ((_originalValue - self.minimumValue) / (self.maximumValue - self.minimumValue)));
...
@interface AlivcRaceLiveBeautifySliderTooltip : UIView

@end

@implementation AlivcRaceLiveBeautifySliderTooltip {
    UILabel *_textLabel;
}
...
@implementation AlivcRaceLiveBeautifySliderView {
    AlivcRaceLiveBeautifySlider *_slider;
    AlivcRaceLiveBeautifySliderTooltip *_toolTip;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _slider = [[AlivcRaceLiveBeautifySlider alloc] initWithFrame:
                        CGRectMake(15,
                                   29,
                                   CGRectGetWidth(self.bounds) - 15 * 2.f,
                                   CGRectGetHeight(_slider.bounds))];
        _slider.aliViewDidLayout = ^(AlivcRaceLiveBeautifySlider *slider) {
        ...
        _toolTip = [[AlivcRaceLiveBeautifySliderTooltip alloc] initWithFrame:CGRectMake(0, 0, 44, 29)];
//        _toolTip.hidden = YES;
