...
@implementation AlivcRaceLiveBeautifyNavigationView {
    ...
    void(^_leftAction)(AlivcRaceLiveBeautifyNavigationView *sender);
    void(^_rightAction)(AlivcRaceLiveBeautifyNavigationView *sender);
}
