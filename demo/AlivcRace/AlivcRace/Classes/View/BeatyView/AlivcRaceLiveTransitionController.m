...
#import "AlivcRaceLivePresentationController.h"

static const NSTimeInterval AlivcLiveTransitionDuration = 0.27f;

@implementation AlivcRaceLiveTransitionController
...
sourceViewController:(__unused UIViewController *)source {
    return [[AlivcRaceLivePresentationController alloc] initWithPresentedViewController:presented
