...
NSString * const AlivcRaceBeautyParamsTypeShortVideo_Base = @"AlivcRacePushBeautyParamsTypeShortVideo_Base";
NSString * const AlivcRaceBeautyParamsTypeShortVideo_Advanced = @"AlivcRacePushBeautyParamsTypeShortVideo_Advanced";
NSString * const AlivcRaceBeautyParamsTypeShortVideo_BeautySkin = @"AlivcRaceBeautyParamsTypeShortVideo_BeautySkin";
NSString * const AlivcRaceBeautyParamsTypeShortVideo_BeautyShape = @"AlivcRaceBeautyParamsTypeShortVideo_BeautyShape";


@interface AlivcRacePushBeautyDataManager()
...
@implementation AlivcRacePushBeautyDataManager
...
- (void)saveDefaultParams{
    ...
    if (!_haveSavedDefaultValue) {
        ...
        for(int i = 0;i < maxValue;i ++){
            AlivcRacePushBeautyParams *params = [self defaultBeautyParamsWithLevel:i];
...
- (AlivcRacePushBeautyParams *)defaultBeautyParamsWithLevel:(AlivcPushBeautyParamsLevel)level{
    ...
    return [[AlivcRacePushBeautyParams alloc] init];
    
}

/// 互动直播的默认美颜参数
/// @param level 美颜等级
- (AlivcRacePushBeautyParams *)defaultLiveParamsWithLevel:(AlivcPushBeautyParamsLevel)level{
    AlivcRacePushBeautyParams *params = [[AlivcRacePushBeautyParams alloc] init];
    CGFloat scale = 1;
...
///  默认的FU在短视频的默认参数
/// @param level 美颜等级
- (AlivcRacePushBeautyParams *)defaultFuShortVideoParamsWithLevel:(AlivcPushBeautyParamsLevel)level{
    AlivcRacePushBeautyParams *params = [[AlivcRacePushBeautyParams alloc] init];
...
- (AlivcRacePushBeautyParams *)defaultRaceShortVideoParamsWithlevel:(AlivcPushBeautyParamsLevel)shapeType{
...
- (AlivcRacePushBeautyParams *)paramsWithValueArray:(NSArray <NSNumber *>*)valueArray{
    AlivcRacePushBeautyParams *params = [[AlivcRacePushBeautyParams alloc] init];
...
/// 获取对应等级的参数
/// @param level 对应等级
- (AlivcRacePushBeautyParams *)getBeautyParamsOfLevel:(AlivcPushBeautyParamsLevel)level{
    AlivcRacePushBeautyParams *parames = [[AlivcRacePushBeautyParams alloc]init];
...
/// @param level 等级
- (void)saveBeautyParams:(AlivcRacePushBeautyParams *)beautyParams level:(AlivcPushBeautyParamsLevel)level{
...
- (NSDictionary *)dicWithBeautyParamEnum:(AlivcBeautyParamsEnum)enumItem{
    ...
    AlivcRacePushBeautyParams *params = [self getBeautyParamsOfLevel:level];
    AlivcRacePushBeautyParams *defaultParams = [self defaultBeautyParamsWithLevel:level];
...
- (NSString *)keyStringForBeautyParamValueWithParam:(AlivcBeautyParamsEnum)paramEnum level:(AlivcPushBeautyParamsLevel)level {
    ...
    NSString *paramString = [AlivcRacePushBeautyParams keyStringWithParamEnum:paramEnum];
