...
#import "AlivcRacePushBeautyDataManager.h"
#import "AlivcShortVideoRoute.h"
#import "AlivcRaceLiveBeautifyLevelView.h"

@interface AlivcRaceRecordBeautyView()<AlivcRaceLiveBeautifySettingsViewControllerDelegate>
@property (nonatomic, strong) AlivcRaceLiveBeautifySettingsViewController *beatyFaceViewControl;//美颜界面
@property (nonatomic, strong) AlivcRaceLiveBeautifySettingsViewController *beatySkinViewControl;//美型界面
@property (nonatomic, strong) AlivcRaceLiveBeautifySettingsViewController *beatyShapeViewControl;//美型界面

@property (nonatomic, strong) AlivcRacePushBeautyDataManager *beautyFaceDataManager_normal;     //普通美颜的数据管理器
@property (nonatomic, strong) AlivcRacePushBeautyDataManager *beautyFaceDataManager_advanced;   //高级美颜的数据管理器
@property (nonatomic, strong) AlivcRacePushBeautyDataManager *beautySkinDataManager;            //美型的数据管理器
@property (nonatomic, strong) AlivcRacePushBeautyDataManager *beautyShapeDataManager;           //Race美型的数据管理器


@end
//TODO:只做了基础的UI托板的优化，和部分美颜代理方法的优化，AlivcLiveBeautifySettingsViewController可以优化成View，更方便使用
@implementation AlivcRaceRecordBeautyView
...
- (AlivcRaceLiveBeautifySettingsViewController *)beatyFaceViewControl{
    ...
    if (!_beatyFaceViewControl) {
        ...
        _beatyFaceViewControl = [AlivcRaceLiveBeautifySettingsViewController settingsViewControllerWithLevel:level detailItems:dics];
...
- (AlivcRaceLiveBeautifySettingsViewController *)beatySkinViewControl{
    __weak typeof(self) weakSelf = self;
    if (!_beatySkinViewControl) {
        ...
        _beatySkinViewControl = [AlivcRaceLiveBeautifySettingsViewController settingsViewControllerWithLevel:level detailItems:dics];
...
- (AlivcRaceLiveBeautifySettingsViewController *)beatyShapeViewControl {
    __weak typeof(self) weakSelf = self;
    if (!_beatyShapeViewControl) {
        ...
        _beatyShapeViewControl = [AlivcRaceLiveBeautifySettingsViewController settingsViewControllerWithLevel:level detailItems:dics];
...
- (AlivcRacePushBeautyDataManager *)beautyFaceDataManager_normal{
    if (!_beautyFaceDataManager_normal) {
        _beautyFaceDataManager_normal = [[AlivcRacePushBeautyDataManager alloc]initWithType:AlivcBeautyParamsTypeFU_ShortVideo customSaveString:AlivcRaceBeautyParamsTypeShortVideo_Base];
    }
    return _beautyFaceDataManager_normal;
}
- (AlivcRacePushBeautyDataManager *)beautyFaceDataManager_advanced{
    if (!_beautyFaceDataManager_advanced) {
        _beautyFaceDataManager_advanced = [[AlivcRacePushBeautyDataManager alloc]initWithType:AlivcBeautyParamsTypeFU_ShortVideo customSaveString:AlivcRaceBeautyParamsTypeShortVideo_Advanced];
    }
    return _beautyFaceDataManager_advanced;
}
- (AlivcRacePushBeautyDataManager *)beautySkinDataManager{
    if (!_beautySkinDataManager) {
        _beautySkinDataManager = [[AlivcRacePushBeautyDataManager alloc]initWithType:AlivcBeautyParamsTypeFU_ShortVideo customSaveString:AlivcRaceBeautyParamsTypeShortVideo_BeautySkin];
    }
    return _beautySkinDataManager;
}
- (AlivcRacePushBeautyDataManager *)beautyShapeDataManager{
    if (!_beautyShapeDataManager) {
        _beautyShapeDataManager = [[AlivcRacePushBeautyDataManager alloc]initWithType:AlivcBeautyParamsTypeRace_ShortVideo customSaveString:AlivcRaceBeautyParamsTypeShortVideo_BeautyShape];
    }
...
- (void)settingBeautyParams{
    ...
    //当前美颜类型
    _currentBeautyType = (AlivcBeautySettingViewStyle)[[NSUserDefaults standardUserDefaults] integerForKey:@"shortVideoRace_beautyType"];
    //美型参数
...
- (void)setLevelViewTitle:(NSString *)title {
    AlivcRaceLiveBeautifyLevelView *levelView = [self.beatySkinViewControl.view viewWithTag:8855];
...
- (void)settingsViewController:(AlivcRaceLiveBeautifySettingsViewController *)viewController didChangeLevel:(NSInteger)level{
...
- (void)settingsViewController:(AlivcRaceLiveBeautifySettingsViewController *)viewController didChangeValue:(NSDictionary *)info{
    switch (viewController.currentStyle) {
...
- (void)settingsViewController:(AlivcRaceLiveBeautifySettingsViewController *)viewController didChangeUIStyle:(AlivcBeautySettingViewStyle)uiStyle{
    ...
    [defaults setInteger:uiStyle forKey:@"shortVideoRace_beautyType"];
...
- (void)settingsViewControllerDidSelectHowToGet:(AlivcRaceLiveBeautifySettingsViewController *)viewController{
