...
typedef NS_ENUM(NSInteger,AlivcBeautySettingViewStyle){
    ...
    AlivcBeautySettingViewStyle_ShortVideo_BeautySkin = 3, //短视频里的美型，没有高级普通的区分
    AlivcBeautySettingViewStyle_ShortVideo_BeautyShape = 4, //短视频里的美型，没有高级普通的区分
};

@interface AlivcRaceBeautySettingUIDefine : NSObject
