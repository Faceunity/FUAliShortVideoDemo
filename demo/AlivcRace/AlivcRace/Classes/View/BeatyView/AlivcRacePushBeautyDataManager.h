...
//基础美颜参数管理器key
extern NSString * const AlivcRaceBeautyParamsTypeShortVideo_Base;
//高级美颜参数管理器key
extern NSString * const AlivcRaceBeautyParamsTypeShortVideo_Advanced;
//美型参数管理器key
extern NSString * const AlivcRaceBeautyParamsTypeShortVideo_BeautySkin;
//美型参数管理器key
extern NSString * const AlivcRaceBeautyParamsTypeShortVideo_BeautyShape;
...
@interface AlivcRacePushBeautyDataManager : NSObject
