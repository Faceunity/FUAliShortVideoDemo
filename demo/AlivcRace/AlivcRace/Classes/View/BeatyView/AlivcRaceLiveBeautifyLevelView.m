...
@interface RaceButtonsContentView : UIView
...
@implementation RaceButtonsContentView
...
@implementation AlivcRaceLiveBeautifyLevelView{
    AlivcRaceLiveBeautifyNavigationView *_navigationView;
    NSArray<UIButton *> *_buttons;
    RaceButtonsContentView *_buttonsContentView;
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _navigationView = [AlivcRaceLiveBeautifyNavigationView navigationViewTitleView:titleButton];
        [self addSubview:_navigationView];
        
        _buttonsContentView = [[RaceButtonsContentView alloc] initWithFrame:CGRectZero];
